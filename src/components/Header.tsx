      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <Toggle pressed={isDarkTheme} onPressedChange={toggleTheme} className="border-white/20 dark:border-gray-700 hover:bg-white/10 hover:text-white transition-colors duration-300">
              {isDarkTheme ? <Moon size={18} /> : <Sun size={18} />}
            </Toggle>
            
            <Button variant="outline" onClick={onRefresh} className="border-white/20 dark:border-gray-700 hover:bg-white/10 hover:text-white transition-colors duration-300">
            ...
            <Dialog open={isApiKeyDialogOpen} onOpenChange={setIsApiKeyDialogOpen}>
              ...
              <DialogContent className="sm:max-w-md dark:bg-gray-800 dark:text-white transition-colors duration-300">
                <DialogHeader>
                  <DialogTitle className="text-lg font-normal px-0 py-[4px] my-[3px] mx-[2px]">Настройка API ключа OpenAI</DialogTitle>
                </DialogHeader>
                <div className="flex flex-col gap-4 py-4">
                  ...
                  <Input placeholder="sk-..." value={openApiKey} onChange={handleApiKeyChange} className="col-span-3 dark:bg-gray-700 dark:text-white dark:border-gray-600 transition-colors duration-300" />
            ...
            <Dialog open={isWbTokenDialogOpen} onOpenChange={setIsWbTokenDialogOpen}>
              ...
              <DialogContent className="sm:max-w-md dark:bg-gray-800 dark:text-white transition-colors duration-300">
                ...
                <div className="flex flex-col gap-4 py-4">
                  ...
                  <Input placeholder="Bearer eyJhbG..." value={wbToken} onChange={handleWbTokenChange} className="col-span-3 dark:bg-gray-700 dark:text-white dark:border-gray-600 transition-colors duration-300" />
