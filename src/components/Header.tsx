...
const Header = ({ unansweredCount, onRefresh }: HeaderProps) => {
  ...
  return (
    <header className="bg-wb-primary text-white p-4 rounded-lg shadow-md mb-6">
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold">Review Reply Rocket</h1>
